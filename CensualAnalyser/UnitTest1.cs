...
namespace CensualAnalyser
{
    ...
    public class Tests
    {
        ...
        static string wrongIndianStateCensusFilePath = @"C:\Users\dell\source\repos\IndianStateCensusAnalyzer\CensualAnalyser\CsvFiles\WrongIndiaStateCensusData.csv";
